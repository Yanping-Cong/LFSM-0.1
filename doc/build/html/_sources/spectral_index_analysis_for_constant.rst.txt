LFSM.spectral_index.spectral_index_analysis_for_constant
================================================================

class::

   class LFSM.spectral_index.spectral_index_analysis_for_constant(object):
...
.. py:function:: calculate_index(downgrade_to)
   ...
   return the spectral index value for constant situation.
